...
HD_PWD='/home/student/Workspace/Exercise1/CH2/SystemVerilog/build/logic_ex.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log logic_ex.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source logic_ex.tcl
